        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                ...
                <div class="row">
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/users/student/student_add5.png') ?>" width="120%" height="100%"/>
                        </div>
                </div>
                ...
                <div class="row">
                       <p><b>STEP 4:</b> You are now in the registration section, you can register a student(s) in two ways: </p>
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/users/student/student_add7.png') ?>" width="120%" height="100%"/>
                        </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                       <p>Fill in the student's parent information and fill in previous academic reports of the student (if available and/or required by the school)</p>
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/users/student/student_add9.png') ?>" width="120%" height="100%"/>
                        </div>
                </div>
               ...
               <p>Click on "Submit" to complete the registration</p>
                <div class="col-sm-8">
                            <img src="<?= url('public/images/users/student/student_add11.png') ?>" width="120%" height="100%"/>
                        </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/users/student/student_add14.png') ?>" width="120%" height="100%"/>
                    </div>
                ...
                <div class="row">
                       ...
                       <p>“Excel Registration Sample” downloaded from ShuleSoft system</p> 
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/users/student/student_add15.png') ?>" width="120%" height="100%"/>
                        </div>
                </div>
                <div class="row">
                <p>If you already have an existing Excel registration file in your system, Click on “browse”</p>
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/users/student/student_add16.png') ?>" width="120%" height="100%"/>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/users/student/student_add17.png') ?>" width="120%" height="100%"/>
                        </div>
                </div>
