...
<div class="container-fluid">
   <div class="row">
      <div class="col-md-12 col-sm-12 col-lg-12">
         <div class="white-box">
            <h3 class="box-title">HOW TO VIEW FAVORITE MESSAGES</h3>
                <div class="row"> 
                <p>The following are the steps to view favorite messages:</p>
                ...
                <p>For mobile phones: Press on menu</p>
                     <div class="col-sm-8">
                     <img src="<?= url('public/images/message/favorite_msg_view2.png') ?>" width="80%" height="80%"/>
                     </div>
                </div>
                ...
                <div class="row"> 
                  <p>For mobile phones:</p>
                     <div class="col-sm-8">
                     <img src="<?= url('public/images/message/favorite_msg_view5.png') ?>" width="80%" height="80%"/>
                     </div>
                </div>
                ...
                <p>For mobile phones:</p>
                     <div class="col-sm-8">
                     <img src="<?= url('public/images/message/favorite_msg_view7.png') ?>" width="80%" height="80%"/>
                     </div>
                </div>
         </div>
      </div>
