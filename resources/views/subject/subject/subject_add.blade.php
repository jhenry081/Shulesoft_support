...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                <h3 class="box-title">HOW TO ADD SUBJECT</h3>
                <div class="row">
                <p>The following are the steps to add a subject(s):</p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/subject/subject/subject_add2.png') ?>" width="40%" height="60%"/>
                    </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                ...
                <p>Click on "Subject"</p>
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/subject/subject/subject_add3.png') ?>" width="40%" height="60%"/>
                        </div>
                </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                <div class="row">
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/subject/subject/subject_add5.png') ?>" width="40%" height="60%"/>
                        </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                <div class="row">
                        ...
                        <p>For mobile phones:</p>
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/subject/subject/subject_add7.png') ?>" width="40%" height="60%"/>
                        </div>
            ...
            <div class="white-box">
                <div class="row">
                    <ul>
                        <p>For mobile phones:</p>
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/subject/subject/subject_add9.png') ?>" width="40%" height="60%"/>
                        </div>
                    </ul>
                </div>
                <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                <div class="row">
                        ...
                        <p>For mobile phones:</p>
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/subject/subject/subject_add11.png') ?>" width="40%" height="60%"/>
                        </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                ...
                <div class="row">
                    <p>For mobile phones:</p>
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/subject/subject/subject_add14.png') ?>" width="40%" height="60%"/>
                        <p></p>
