            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="<?=url('/')?>">
                        ...
                        <img src="<?= url('public/images/ShuleSoft-TM.png') ?>" width="150" alt="home" class="dark-logo" />
                        <!--This is light logo icon-->
                        <img src="<?= url('public/images/ShuleSoft-TM.png') ?>" width="150" alt="home" class="light-logo" />
                     </b>
...
<!--                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><span class="hidden-xs">Mega</span> <i class="icon-options-vertical"></i></a>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right" style="background: #efefef !important;
