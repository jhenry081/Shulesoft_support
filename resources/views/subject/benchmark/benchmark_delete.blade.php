...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                <h3 class="box-title">HOW TO DELETE BENCHMARK</h3>
                <div class="row">
                    <p>To add benchmark in ShuleSoft system you should Login first to the system and do the following procedures:</p>
                    <ol>
                        <li>On side bar select “Subject”</li>
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/subject/benchmark/benchmark_delete1.png') ?>" width="80%" height="80%"/>
                        </div>
                    </ol>
                </div>
                <div class="row">
