        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                ...
                <div class="row">
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/users/student/student_delete11.png') ?>" width="120%" height="100%"/>
                        </div>
                </div>
                ...
                <div class="row">
                   <p>ii. Click on “view” to review student information in detail before deleting</p>
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/users/student/student_delete12.png') ?>" width="120%" height="100%"/>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/users/student/student_delete13.png') ?>" width="120%" height="100%"/>
                        </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/users/student/student_delete14.png') ?>" width="120%" height="100%"/>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/users/student/student_delete16.png') ?>" width="120%" height="100%"/>
                    </div>
                </div>
