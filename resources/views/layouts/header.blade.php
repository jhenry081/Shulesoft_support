            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="index.html">
                        ...
                        <!--This is dark logo text--><img src="../plugins/images/admin-text.png" alt="home" class="dark-logo" /><!--This is light logo text--><img src="../plugins/images/admin-text-dark" alt="home" class="light-logo" />
                     </span> </a>
                </div>
                <!-- /Logo -->
