            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo">
                        ...
                        <!--This is dark logo icon--><img src="<?= url('public/images/ShuleSoft-TM.png') ?>" width="100%" alt="home" class="dark-logo" />
                        <!--This is light logo icon--><img src="<?= url('public/images/ShuleSoft-TM.png') ?>" width="100%" alt="home" class="light-logo" />
                     </b>
                        <!-- Logo text image you can use text also --><span class="hidden-xs">
                        <!--This is dark logo text-->
                        <img src="<?= url('public/images/ShuleSoft-TM.png') ?>" width="100%" alt="home" class="dark-logo" />
