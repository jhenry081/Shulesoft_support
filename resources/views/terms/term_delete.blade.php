         ...
         <div class="white-box">
            <h3 class="box-title">HOW TO DELETE TERMS</h3>
                ...
                <p>On the Sidebar, select "Terms"</p>
                      ...
                      <div class="col-sm-8">
                      <img src="<?= url('public/images/term/term_delete1.png') ?>" width="120%" height="100%"/>
                      </div>
                ...
                <p>Select class and class level</p>
                     <div class="col-sm-8">
                     <img src="<?= url('public/images/term/term_delete4.png') ?>" width="120%" height="100%"/>
                     </div>
                </div>
                ...
                <p>Click on “View”</p>
                     <div class="col-sm-8">
                     <img src="<?= url('public/images/term/term_delete6.png') ?>" width="120%" height="100%"/>
                     </div>
                </div>
                ...
                <p>Click “Delete” on the respective terms</p>
                     <div class="col-sm-8">
                     <img src="<?= url('public/images/term/term_delete7.png') ?>" width="120%" height="100%"/>
                     </div>
                </div>
