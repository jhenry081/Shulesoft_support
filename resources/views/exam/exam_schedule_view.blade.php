...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                <h3 class="box-title">HOW TO VIEW EXAM SCHEDULE</h3>
                <div class="row">
                <p>The following are the steps to view defined exam schedules:</p>
            ...
            <div class="white-box">
                <div class="row">
                 ...
                 (ii)Schedule</p>
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/exam/exam schedule/view/3.png') ?>" width="40%" height="60%"/>
                        </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/exam/exam schedule/view/6.png') ?>" width="40%" height="60%"/>
                    </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                ...
                <div class="row">
                    ...
                    <p>For mobile phones:</p>
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/exam/exam schedule/view/8.png') ?>" width="40%" height="60%"/>
                    </div>
