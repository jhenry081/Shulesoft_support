                ...
                <ul class="nav" id="side-menu">
                    ...
                    <a href="index.html" class="waves-effect"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i>
                     <span class="hide-menu"> Section <span class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="<?=url('section/introduction')?>"><i class=" fa-fw">1</i><span class="hide-menu">Introduction</span></a> </li>
                            <li> <a href="index2.html"><i class=" fa-fw">2</i><span class="hide-menu">Add section</span></a> </li>
                            <li> <a href="index3.html"><i class=" fa-fw">3</i><span class="hide-menu">view section</span></a> </li>
                        </ul>
                    </li>
                    ...
                    <li class="devider"></li>
                    <li> <a href="forms.html" class="waves-effect"><i class="mdi mdi-clipboard-text fa-fw"></i> <span class="hide-menu">Student Form<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="form-basic.html"><i class="fa-fw">B</i><span class="hide-menu">Basic Student Forms</span></a></li>
...
>>>>>>> c85ff018b181ae8eb8de65fc42084005a2047170
        </div>