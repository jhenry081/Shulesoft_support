        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <img src="<?= url('public/images/notice/add/2.png') ?>" width="40%" height="60%"/>
                    </div>
</ol>
                </div>
            </div>
            ...
            <div class="white-box">
                <div class="row">
                    ...
                    <p>	(i)Click on "notice"</p>
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/notice/add/3.png') ?>" width="40%" height="60%"/>
                        </div>
        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="white-box">
                <div class="row">
                        ...
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/notice/add/5.png') ?>" width="40%" height="60%"/>
                        </div>
                ...
                <div class="row">
                  ...
                  <div class="row">
                        ...
                        <p>For mobile phones:</p>
                        <div class="col-sm-8">
                            <img src="<?= url('public/images/notice/add/7.png') ?>" width="40%" height="60%"/>
                        </div>
